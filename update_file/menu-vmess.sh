...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/andristji/IP-Register/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/andristji/IP-Register/main/ipmini | grep $MYIP | awk '{print $2}')
...
IP-Register () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/andristji/IP-Register/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}            •   NILPHREAKZ-VPN   •           "
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo ""
